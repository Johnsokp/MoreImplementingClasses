...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.cl_num = 0
        self.begin_start = start.clone()
        self.begin_end = end.clone()
    ...
    def length(self):
        ...
        return (((self.end.x - self.start.x) ** 2) + ((self.end.y -
                                                      self.start.y) ** 2)) \
               ** 0.5
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        p1 = Point((self.start.x + other_line.start.x), (self.start.y +
                                                     other_line.start.y))
        p2 = Point((self.end.x + other_line.end.x), (self.end.y +
                                                     other_line.end.y))
        return Line(p1, p2)
